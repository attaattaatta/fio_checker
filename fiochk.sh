        ...
        echo;
			...
			parse_fio_results;
                ...
                for z in ${OPSTYPE[@]:2:3}; do
                        ...
                        declare "RND4KQ32T1$z=$($FIO_PRE --blocksize=4k --iodepth=32 --size=256M --rw=$z --numjobs=1 $FIO_POST ; rm -f testio$FIO_RNDNAME*);"
			...
			parse_fio_results;
                        ...
                        declare "RND4KQ1T1$z=$($FIO_PRE --blocksize=4k --iodepth=1 --size=256M --rw=$z --numjobs=1 $FIO_POST ; rm -f testio$FIO_RNDNAME*);"
                        test_result="RND4KQ1T1$z";
                        echo "${!test_result}";
